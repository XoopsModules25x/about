...
<form id="form" name="form" method="post" action="admin.page.php">
    <table id="about-pageList" class="outer">
        ...
        <th width="10%" align="center"><{$smarty.const._AM_ABOUT_PAGE_TEMPLATE}></th>
        <th width="4%" align="center"><{$smarty.const._AM_ABOUT_PAGE_TYPE}></th>
        <th width="4%" align="center"><{$smarty.const._AM_ABOUT_PAGE_STATUS_LIST}></th>
        <th width="4%" align="center"><{$smarty.const._AM_ABOUT_PAGE_MENU}></th>
        <th width="15%" align="center"><{$smarty.const._AM_ABOUT_TIME}></th>
        <th width="10%" align="center"><{$smarty.const._AM_ABOUT_PAGE_AUTHOR}></th>
